...
<x-card class="p-10 max-w-lg mx-auto mt-24">
    ...
    <form method="POST" action="/listings/{{$listing->id}}" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            <label for="deadline" class="inline-block text-lg mb-2">Deadline</label>
            <input type="date" class="border border-gray-200 rounded p-2 w-full" name="deadline" value="{{ $listing->deadline }}"/>
